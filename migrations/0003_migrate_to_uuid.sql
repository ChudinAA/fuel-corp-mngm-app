...
ALTER TABLE permissions ADD COLUMN new_id UUID DEFAULT gen_random_uuid();
...
ALTER TABLE role_permissions ADD COLUMN new_id UUID DEFAULT gen_random_uuid();
ALTER TABLE role_permissions ADD COLUMN new_role_id UUID;
ALTER TABLE role_permissions ADD COLUMN new_permission_id UUID;
UPDATE role_permissions SET new_role_id = int_to_uuid(role_id::INTEGER);
UPDATE role_permissions SET new_permission_id = int_to_uuid(permission_id::INTEGER);
...
UPDATE users SET new_role_id = int_to_uuid(role_id::INTEGER) WHERE role_id IS NOT NULL;
...
ALTER TABLE customers ADD COLUMN new_id UUID DEFAULT gen_random_uuid();
...
ALTER TABLE wholesale_bases ADD COLUMN new_id UUID DEFAULT gen_random_uuid();
...
ALTER TABLE wholesale_suppliers ADD COLUMN new_id UUID DEFAULT gen_random_uuid();
ALTER TABLE wholesale_suppliers ADD COLUMN new_default_base_id UUID;
UPDATE wholesale_suppliers SET new_id = int_to_uuid(id);
UPDATE wholesale_suppliers SET new_default_base_id = int_to_uuid(default_base_id::INTEGER) WHERE default_base_id IS NOT NULL;
...
ALTER TABLE refueling_bases ADD COLUMN new_id UUID DEFAULT gen_random_uuid();
...
ALTER TABLE refueling_providers ADD COLUMN new_id UUID DEFAULT gen_random_uuid();
ALTER TABLE refueling_providers ADD COLUMN new_default_base_id UUID;
UPDATE refueling_providers SET new_id = int_to_uuid(id);
UPDATE refueling_providers SET new_default_base_id = int_to_uuid(default_base_id::INTEGER) WHERE default_base_id IS NOT NULL;
...
ALTER TABLE logistics_carriers ADD COLUMN new_id UUID DEFAULT gen_random_uuid();
...
ALTER TABLE logistics_delivery_locations ADD COLUMN new_id UUID DEFAULT gen_random_uuid();
...
ALTER TABLE logistics_vehicles ADD COLUMN new_id UUID DEFAULT gen_random_uuid();
ALTER TABLE logistics_vehicles ADD COLUMN new_carrier_id UUID;
UPDATE logistics_vehicles SET new_id = int_to_uuid(id);
UPDATE logistics_vehicles SET new_carrier_id = int_to_uuid(carrier_id::INTEGER) WHERE carrier_id IS NOT NULL;
...
ALTER TABLE logistics_trailers ADD COLUMN new_id UUID DEFAULT gen_random_uuid();
ALTER TABLE logistics_trailers ADD COLUMN new_carrier_id UUID;
UPDATE logistics_trailers SET new_id = int_to_uuid(id);
UPDATE logistics_trailers SET new_carrier_id = int_to_uuid(carrier_id::INTEGER) WHERE carrier_id IS NOT NULL;
...
ALTER TABLE logistics_drivers ADD COLUMN new_id UUID DEFAULT gen_random_uuid();
ALTER TABLE logistics_drivers ADD COLUMN new_carrier_id UUID;
UPDATE logistics_drivers SET new_id = int_to_uuid(id);
UPDATE logistics_drivers SET new_carrier_id = int_to_uuid(carrier_id::INTEGER) WHERE carrier_id IS NOT NULL;
...
ALTER TABLE logistics_warehouses ADD COLUMN new_id UUID DEFAULT gen_random_uuid();
...
ALTER TABLE warehouses ADD COLUMN new_id UUID DEFAULT gen_random_uuid();
...
ALTER TABLE prices ADD COLUMN new_id UUID DEFAULT gen_random_uuid();
ALTER TABLE prices ADD COLUMN new_counterparty_id UUID;
UPDATE prices SET new_id = int_to_uuid(id);
UPDATE prices SET new_counterparty_id = int_to_uuid(counterparty_id::INTEGER);
...
ALTER TABLE delivery_cost ADD COLUMN new_id UUID DEFAULT gen_random_uuid();
...
UPDATE delivery_cost SET new_carrier_id = int_to_uuid(carrier_id::INTEGER);
UPDATE delivery_cost SET new_delivery_location_id = int_to_uuid(delivery_location_id::INTEGER);
...
ALTER TABLE warehouse_transactions ADD COLUMN new_id UUID DEFAULT gen_random_uuid();
...
UPDATE warehouse_transactions SET new_warehouse_id = int_to_uuid(warehouse_id::INTEGER);
UPDATE warehouse_transactions SET new_source_id = int_to_uuid(source_id::INTEGER) WHERE source_id IS NOT NULL;
...
ALTER TABLE exchange ADD COLUMN new_id UUID DEFAULT gen_random_uuid();
...
UPDATE exchange SET new_warehouse_id = int_to_uuid(warehouse_id::INTEGER) WHERE warehouse_id IS NOT NULL;
UPDATE exchange SET new_created_by_id = int_to_uuid(created_by_id::INTEGER) WHERE created_by_id IS NOT NULL;
...
ALTER TABLE movement ADD COLUMN new_id UUID DEFAULT gen_random_uuid();
...
UPDATE movement SET new_supplier_id = int_to_uuid(supplier_id::INTEGER) WHERE supplier_id IS NOT NULL;
UPDATE movement SET new_from_warehouse_id = int_to_uuid(from_warehouse_id::INTEGER) WHERE from_warehouse_id IS NOT NULL;
UPDATE movement SET new_to_warehouse_id = int_to_uuid(to_warehouse_id::INTEGER);
UPDATE movement SET new_carrier_id = int_to_uuid(carrier_id::INTEGER) WHERE carrier_id IS NOT NULL;
UPDATE movement SET new_created_by_id = int_to_uuid(created_by_id::INTEGER) WHERE created_by_id IS NOT NULL;
...
-- Migrate opt table
ALTER TABLE opt ADD COLUMN new_id UUID DEFAULT gen_random_uuid();
...
UPDATE opt SET new_supplier_id = int_to_uuid(supplier_id::INTEGER);
UPDATE opt SET new_buyer_id = int_to_uuid(buyer_id::INTEGER);
UPDATE opt SET new_purchase_price_id = int_to_uuid(purchase_price_id::INTEGER) WHERE purchase_price_id IS NOT NULL;
UPDATE opt SET new_sale_price_id = int_to_uuid(sale_price_id::INTEGER) WHERE sale_price_id IS NOT NULL;
UPDATE opt SET new_carrier_id = int_to_uuid(carrier_id::INTEGER) WHERE carrier_id IS NOT NULL;
UPDATE opt SET new_delivery_location_id = int_to_uuid(delivery_location_id::INTEGER) WHERE delivery_location_id IS NOT NULL;
UPDATE opt SET new_created_by_id = int_to_uuid(created_by_id::INTEGER) WHERE created_by_id IS NOT NULL;
...
ALTER TABLE aircraft_refueling ADD COLUMN new_id UUID DEFAULT gen_random_uuid();
...
UPDATE aircraft_refueling SET new_supplier_id = int_to_uuid(supplier_id::INTEGER);
UPDATE aircraft_refueling SET new_buyer_id = int_to_uuid(buyer_id::INTEGER);
UPDATE aircraft_refueling SET new_purchase_price_id = int_to_uuid(purchase_price_id::INTEGER) WHERE purchase_price_id IS NOT NULL;
UPDATE aircraft_refueling SET new_sale_price_id = int_to_uuid(sale_price_id::INTEGER) WHERE sale_price_id IS NOT NULL;
UPDATE aircraft_refueling SET new_created_by_id = int_to_uuid(created_by_id::INTEGER) WHERE created_by_id IS NOT NULL;
