...
UPDATE roles SET new_id = gen_random_uuid() WHERE new_id IS NULL;
...
UPDATE permissions SET new_id = gen_random_uuid() WHERE new_id IS NULL;
...
UPDATE role_permissions SET new_id = gen_random_uuid() WHERE new_id IS NULL;
...
UPDATE wholesale_bases SET new_id = gen_random_uuid() WHERE new_id IS NULL;
...
UPDATE refueling_bases SET new_id = gen_random_uuid() WHERE new_id IS NULL;
...
UPDATE refueling_providers SET new_id = gen_random_uuid() WHERE new_id IS NULL;
...
UPDATE logistics_carriers SET new_id = gen_random_uuid() WHERE new_id IS NULL;
...
UPDATE logistics_delivery_locations SET new_id = gen_random_uuid() WHERE new_id IS NULL;
...
UPDATE logistics_vehicles SET new_id = gen_random_uuid() WHERE new_id IS NULL;
...
UPDATE logistics_trailers SET new_id = gen_random_uuid() WHERE new_id IS NULL;
...
UPDATE logistics_drivers SET new_id = gen_random_uuid() WHERE new_id IS NULL;
...
UPDATE logistics_warehouses SET new_id = gen_random_uuid() WHERE new_id IS NULL;
...
UPDATE warehouses SET new_id = gen_random_uuid() WHERE new_id IS NULL;
...
UPDATE prices SET new_id = gen_random_uuid() WHERE new_id IS NULL;
...
UPDATE delivery_cost SET new_id = gen_random_uuid() WHERE new_id IS NULL;
...
UPDATE warehouse_transactions SET new_id = gen_random_uuid() WHERE new_id IS NULL;
...
UPDATE exchange SET new_id = gen_random_uuid() WHERE new_id IS NULL;
...
UPDATE movement SET new_id = gen_random_uuid() WHERE new_id IS NULL;
...
UPDATE opt SET new_id = gen_random_uuid() WHERE new_id IS NULL;
...
UPDATE aircraft_refueling SET new_id = gen_random_uuid() WHERE new_id IS NULL;
