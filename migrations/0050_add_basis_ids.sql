-- Add basis_id to movement
ALTER TABLE "movement" ADD COLUMN IF NOT EXISTS "basis_id" uuid REFERENCES "bases"("id");
...
-- Seed logic: 0. movement.basis_id
UPDATE "movement" m
SET basis_id = b.id
FROM "bases" b
WHERE b.base_type = 'wholesale' AND m.basis = b.name;
