  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-semibold">Склады и хранение</h1>
          <p className="text-muted-foreground">
            Управление складами и зарубежными картами хранения
          </p>
        </div>
      </div>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="mb-4">
          ...
          <TabsTrigger value="storage-cards" className="flex items-center gap-2">
        ...
        <TabsContent value="warehouses" className="space-y-6 mt-0">
          <div className="flex items-center justify-between">
            <h2 className="text-lg font-medium">Склады</h2>
        ...
        <TabsContent value="storage-cards" className="mt-0">
          <StorageCardsPage hideHeader />
        </TabsContent>
      </Tabs>
