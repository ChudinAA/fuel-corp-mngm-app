...
import { COUNTERPARTY_TYPE, COUNTERPARTY_ROLE, PRODUCT_TYPE, CURRENCY } from "@shared/constants";

export const priceFormSchema = z.object({
  dateFrom: z.date({ required_error: "Укажите дату начала" }),
  dateTo: z.date({ required_error: "Укажите дату окончания" }),
  counterpartyType: z.enum([COUNTERPARTY_TYPE.WHOLESALE, COUNTERPARTY_TYPE.REFUELING, COUNTERPARTY_TYPE.REFUELING_ABROAD]),
