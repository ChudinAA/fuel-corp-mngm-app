          ...
          {isLoading ? (
            ...
            data.map((item) => {
              const isPendingReceipt =
                item.buyerSupplierId && !item.isReceivedAtWarehouse;

              return (
                <TableRow
                  key={item.id}
                  className={cn(
                    isPendingReceipt && "bg-amber-50 dark:bg-amber-950/20",
                  )}
                >
                  <TableCell>
                    <div className="flex flex-col gap-1">
                      ...
                      {isPendingReceipt && (
                        <Badge
                          variant="secondary"
                          className="w-fit text-[10px] h-4 px-1.5 bg-amber-100 text-amber-800 border-amber-200 dark:bg-amber-900/40 dark:text-amber-300 dark:border-amber-700"
                        >
