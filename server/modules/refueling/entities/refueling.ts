...
export const aircraftRefueling = pgTable(
  "aircraft_refueling",
  {
    ...
    isPvkjRecharge: boolean("is_pvkj_recharge").default(false),
    setSalePriceZero: boolean("set_sale_price_zero").default(false),
...
export const insertAircraftRefuelingSchema = createInsertSchema(
  ...
  .extend({
    ...
    agentFee: z.number().nullable().optional(),
    profit: z.number().nullable().optional(),
    contractNumber: z.string().nullable().optional(),
    notes: z.string().nullable().optional(),
    isPriceRecharge: z.boolean().optional(),
    isPvkjRecharge: z.boolean().optional(),
    setSalePriceZero: z.boolean().optional(),
