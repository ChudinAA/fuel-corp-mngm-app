...
// Transaction types for storage card operations
export const STORAGE_CARD_TRANSACTION_TYPE = {
  INCOME: "income",
  EXPENSE: "expense",
...
export type StorageCardTransactionType =
  (typeof STORAGE_CARD_TRANSACTION_TYPE)[keyof typeof STORAGE_CARD_TRANSACTION_TYPE];
export type TransactionType =
  (typeof TRANSACTION_TYPE)[keyof typeof TRANSACTION_TYPE];
export type MovementType = (typeof MOVEMENT_TYPE)[keyof typeof MOVEMENT_TYPE];
export type DeliveryEntityType =
  (typeof DELIVERY_ENTITY_TYPE)[keyof typeof DELIVERY_ENTITY_TYPE];
export type CounterpartyType =
  (typeof COUNTERPARTY_TYPE)[keyof typeof COUNTERPARTY_TYPE];
...
export type RecalculationStatus =
  (typeof RECALCULATION_STATUS)[keyof typeof RECALCULATION_STATUS];
